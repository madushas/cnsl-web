...
export default async function AboutPage() {
  const [organizers, advisors] = await Promise.all([
    db
      .select()
      .from(schema.people)
      .where(eq(schema.people.category, "organizer")),
    db
      .select()
      .from(schema.people)
      .where(eq(schema.people.category, "advisor")),
  ]);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main
        id="main-content"
        className="container mx-auto px-4 pt-12 pb-20 space-y-20"
      >
        {/* Hero */}
        <section className="max-w-4xl">
          <Reveal>
            ...
            <p className="mt-5 text-xl text-muted-foreground leading-relaxed">
              A volunteer-driven community recognized by CNCF. We bring together
              students, professionals, and researchers to learn, share, and
              build a strong cloud-native ecosystem in Sri Lanka.
            </p>
          </Reveal>
        </section>
        ...
        <section className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <Reveal>
            <Card className="border-border bg-card">
              ...
              <CardContent className="text-muted-foreground leading-relaxed">
                Create a thriving local community where practitioners and
                learners can grow, collaborate, and contribute to the global
          ...
          <Reveal delay={60}>
            <Card className="border-border bg-card">
              ...
              <CardContent className="text-muted-foreground leading-relaxed">
                Establish Sri Lanka as a recognized hub for cloud-native
                expertise in South Asia, contributing talent and innovation to
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              {
                t: "Monthly Meetups",
                d: "Talks, panels, and networking across cities.",
              },
              {
                t: "CNSL Connect",
                d: "Mentorship cohorts for practical career growth.",
              },
              {
                t: "University Outreach",
                d: "Campus sessions, workshops, and hackathons.",
              },
              {
                t: "Open Source",
                d: "Encouraging contributions and collaboration.",
              },
            ].map((x) => (
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <Reveal className="order-1 lg:order-2 lg:col-span-5" delay={80}>
              ...
              <h2 className="mt-3 text-h2 text-foreground">
                A community built on learning and contribution
              </h2>
              <p className="mt-3 text-muted-foreground">
                We started with a vision to make cloud-native knowledge
                accessible, actionable, and impactful. Our meetups and
                mentorship cohorts help members grow skills, showcase projects,
              ...
              <div className="mt-5 grid gap-3">
                ...
                <div className="rounded-xl border border-border bg-card card-padding-sm">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Workshops, labs, and demos to build real skills.
                  </div>
                </div>
                <div className="rounded-xl border border-border bg-card card-padding-sm">
                  <div className="text-sm font-semibold text-foreground">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Talks, showcases, and partner connections.
                  </div>
                </div>
              </div>
            </Reveal>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground max-w-3xl">
            Explore our core initiatives designed for impact.
          </p>
          <div>
            <Link
              href="/initiatives"
              className="inline-flex items-center rounded-lg bg-blue-600 px-5 py-2 text-sm font-semibold text-white hover:bg-blue-700"
            >
              View Initiatives
            </Link>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              {
                t: "Core Organizers",
                d: "Lead initiatives, events, and partnerships.",
              },
              {
                t: "Volunteers",
                d: "Operations, logistics, content, and outreach.",
              },
              {
                t: "Mentors",
                d: "Guide mentees through structured mentorship.",
              },
              {
                t: "Members",
                d: "Open to anyone interested in cloud-native tech.",
              },
            ].map((x) => (
              <Card key={x.t} className="border-border bg-card">
                <CardHeader className="pb-2">
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {people.organizers.map((p: any) => (
              <Card
                key={p.name}
                className="border-border bg-card transition-card hover:shadow-card-hover"
              >
                <CardContent className="card-padding flex flex-col items-center text-center gap-3">
                  <Image
                    src={p.photo || "/professional-headshot-placeholder.svg"}
                    alt={p.name}
                    className="h-20 w-20 rounded-full object-cover border-2 border-blue-500/20"
                  />
                  <div>
                  ...
                  <div className="flex gap-2 pt-1">
                    {p.linkedin && (
                      <a
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-md bg-white/5 text-muted-foreground hover:bg-blue-600 hover:text-white transition-quick"
                      >
          ...
          <div className="grid gap-6 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Speak, volunteer, mentor, or partner with CNSL.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center rounded-lg border border-border px-5 py-2 text-sm font-semibold text-foreground hover:bg-white/5"
              >
                Contact
              </Link>
            </div>
