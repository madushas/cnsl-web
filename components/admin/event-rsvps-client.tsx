          ...
          <div className="flex flex-col sm:flex-row gap-2 justify-between">
            ...
            <div>
              <div className="flex gap-2">
                ...
                <Button asChild>
                  <Link href={`/admin/events/${slug}/email`}>
                    Email Builder
                  </Link>
                </Button>
          ...
          >
            <DialogContent>
              ...
              <div className="space-y-2 text-sm">
                ...
                />
                {(bulkJob?.successCount != null ||
                  bulkJob?.errorCount != null) && (
                  <div>
          ...
          <Dialog open={importOpen} onOpenChange={setImportOpen}>
            <DialogContent>
              ...
              <div className="space-y-3 text-sm">
                <p>
                  Upload a CSV containing columns like <code>id</code>,{" "}
                  <code>ticketNumber</code>, <code>qrCode</code>, or{" "}
                  <code>email</code>. Only provided fields will be updated.
                </p>
