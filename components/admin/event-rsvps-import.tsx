    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Download RSVP data in CSV format
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-4 border rounded-lg">
              ...
              <div className="flex-1">
                ...
                <a href={`/api/admin/events/${slug}/rsvps/export`} target="_blank" rel="noreferrer">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Upload ticket information via CSV
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-4 border rounded-lg">
              ...
              <div className="flex-1">
                <h3 className="font-semibold mb-1">Import Ticket Numbers & QR Codes</h3>
                <p className="text-sm text-muted-foreground mb-3">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <ul className="ml-4 space-y-1">
                <li>• Must include: <code className="bg-muted px-1 rounded">id</code> or <code className="bg-muted px-1 rounded">email</code></li>
                <li>• Optional columns: <code className="bg-muted px-1 rounded">ticketNumber</code>, <code className="bg-muted px-1 rounded">qrCode</code></li>
      ...
      <Dialog open={importOpen} onOpenChange={setImportOpen}>
        <DialogContent>
          ...
          <div className="space-y-3 text-sm">
            <p>Upload a CSV containing columns like <code className="bg-muted px-1 rounded">id</code>, <code className="bg-muted px-1 rounded">ticketNumber</code>, <code className="bg-muted px-1 rounded">qrCode</code>, or <code className="bg-muted px-1 rounded">email</code>. Only provided fields will be updated.</p>
            <input ref={fileRef} type="file" accept=".csv,text/csv" className="block w-full text-sm" />
            {importResult && (
              <div className="p-3 bg-muted rounded-md">
                <p className="font-medium">Import Complete</p>
                <p className="text-muted-foreground">Updated {importResult.updated ?? 0} of {importResult.total ?? 0} records</p>
              </div>
            )}
          </div>
          <DialogFooter>
