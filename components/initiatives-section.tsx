...
const initiatives = [
  ...
  },
  {
    ...
    description: "Casual tech meetups every month with talks and networking. Build connections that last a lifetime.",
    link: "/events",
  },
]
          ...
          >
            ...
            <CardContent className="relative">
              ...
              <Button asChild variant="outline" className="gap-2">
                <Link href={initiative.link} aria-label={`Learn more about ${initiative.title}`}>
                  Learn More
