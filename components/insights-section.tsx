  ...
  return (
    <section className="container mx-auto px-4 section-spacing">
      <div className="mb-12 md:mb-16 text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">Stay updated with our latest stories and community highlights</p>
      </div>
      <div className="grid gap-8 md:grid-cols-3">
        {latest.map((post, idx) => (
          <Reveal key={post.slug} delay={idx * 60}>
          <Card
            className="group relative overflow-hidden bg-card border-border transition-card hover:shadow-card-hover hover:-translate-y-1 cursor-pointer"
          >
            <div className="relative aspect-[4/3] overflow-hidden">
              ...
              />
              <Badge variant="default" className="absolute left-4 top-4 z-20 shadow-sm">
                {post.category}
              </Badge>
            </div>
