...
export function PartnersSection() {
  const partners = [
    { name: "CNCF", category: "Foundation", logo: "/logos/cncf-gray.svg" },
    {
      ...
      logo: "/logos/aws-gray.svg",
    },
    {
      name: "Google Cloud",
      category: "Cloud Partner",
      logo: "/logos/gcp-gray.svg",
    },
    {
      name: "Microsoft Azure",
      category: "Cloud Partner",
      logo: "/logos/azure-gray.svg",
    },
    {
      name: "University of Colombo",
      category: "Education",
      logo: "/logos/uoc-gray.svg",
    },
    {
      name: "University of Moratuwa",
      category: "Education",
      logo: "/logos/uom-gray.svg",
    },
    {
      name: "WSO2",
      category: "Industry Partner",
      logo: "/logos/wso2-gray.svg",
    },
    ...
    <section className="w-full section-spacing">
      <Reveal className="container mx-auto px-4 mb-12 text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Working together to build a thriving cloud-native ecosystem in Sri
          Lanka
        </p>
      </Reveal>
        ...
        <Reveal>
          <div className="inline-flex flex-col items-center gap-4 rounded-2xl border border-border bg-card px-8 py-8 max-w-2xl shadow-card transition-card">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Join us in empowering Sri Lanka’s tech community. Partner with
              CNSL to support education, mentorship, and innovation.
            </p>
            <Button asChild>
