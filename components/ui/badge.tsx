  ...
  'inline-flex items-center justify-center border px-3 py-1 text-xs font-semibold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none transition-quick overflow-hidden',
  {
    variants: {
      variant: {
        ...
        subtle:
          'bg-muted text-muted-foreground border-transparent rounded-lg',
        success:
          'bg-success/15 text-success border-success/30 rounded-full',
        warning:
          'bg-warning/15 text-warning border-warning/30 rounded-full',
        destructive:
          'bg-destructive/15 text-destructive border-destructive/30 rounded-full',
        info:
          'bg-info/15 text-info border-info/30 rounded-full',
      },
    },
    defaultVariants: {
      variant: 'default',
