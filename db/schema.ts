...
export const eventTopics = pgTable(
  ...
  (t) => [index("event_topics_event_idx").on(t.eventId)],
);
...
export const rsvps = pgTable(
  ...
  (t) => [
    ...
    index("idx_rsvps_event_created_at").on(t.eventId, t.createdAt),
    index("idx_rsvps_account_id").on(t.accountId),
    index("idx_rsvps_event_account").on(t.eventId, t.accountId),
  ],
);
...
export const ticketTemplates = pgTable(
  "ticket_templates",
  {
    ...
    qrConfig: jsonb("qr_config").notNull(),
...
export const checkpointScans = pgTable(
  ...
  (t) => [
    ...
    uniqueIndex("checkpoint_scans_unique").on(
      t.rsvpId,
      t.eventId,
      t.checkpointType,
    ),
    ...
    index("idx_checkpoint_scans_event_rsvp_type_time").on(
      t.eventId,
      t.rsvpId,
      t.checkpointType,
      t.scannedAt,
...
export const checkpointScansRelations = relations(
  checkpointScans,
  ({ one }) => ({
    rsvp: one(rsvps, {
