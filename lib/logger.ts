...
const SENSITIVE_FIELDS = ['password', 'token', 'apiKey', 'secret', 'authorization', 'cookie', 'hp']
...
export const logger = {
  ...
  api: (method: string, endpoint: string, statusCode: number, duration: number, meta?: LogMeta) => {
