...
export const CheckpointColors: Record<
  CheckpointType,
...
export function isValidCheckpointType(value: unknown): value is CheckpointType {
  return (
    typeof value === "string" &&
    Object.values(CheckpointType).includes(value as CheckpointType)
  );
}
...
export function isValidScanMethod(value: unknown): value is ScanMethod {
  return (
    typeof value === "string" &&
    Object.values(ScanMethod).includes(value as ScanMethod)
  );
}
